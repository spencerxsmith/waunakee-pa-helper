...
const AUDIO_PACK = [
  "./public/audio/goal-horn.mp3", "./public/audio/goal-burst.mp3",
  "./public/audio/final-buzzer.mp3", "./public/audio/whistle.mp3",
  "./public/audio/big-cheer.mp3", "./public/audio/applause.mp3",
  "./public/audio/crowd-rise.mp3", "./public/audio/aw-so-close.mp3",
  "./public/audio/warriors-win.mp3", "./public/audio/hype-hit.mp3",
  "./public/audio/drum-charge.mp3", "./public/audio/coin-chime.mp3"
];
